            ...
            return (
              <SwiperSlide className="w-full" key={c}>
                <div className="w-full flex flex-col gap-4 relative">
                  {/* isNew */}
                  <div className="w-[57px] h-[27px] md:w-[81px] md:h-[40px] md:rounded-[20px] rounded-[10px] bg-mainBlack absolute inset-0 z-[2] flex items-center justify-center">
                    <p className="text-[13px] leading-[16px] md:text-[16px] md:leading-[18px] text-white font-montserrat font-normal">
                      New
                    </p>
                  </div>
                  {/* like */}
