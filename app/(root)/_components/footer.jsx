...
const Footer = () => {
  ...
  return (
    <div className="w-full h-[370px] bg-[#F5E7E7] border-t border-t-[#453C3C33]/20">
      <div className="polo:w-[1280px] justify-between mx-auto w-[94%] h-full flex flex-col py-[50px] gap-[30px]">
        <div className="hidden minitablet:flex  justify-between">
          {/* 1 */}
          ...
          <div className="flex flex-col gap-[20px]">
            {/* language */}
            <div className="hidden minitablet:flex items-center gap-2 h-[46px]">
          ...
          <div className="flex flex-col gap-[20px] min-w-[270px]">
            ...
            <div className="flex flex-col gap-[15px] polo:hidden">
              <p className="text-[16px] leading-[20px] text-mainBlack font-semibold font-montserrat">
                {t("footer.p13")}
              </p>
              <p className="text-[16px] leading-[20px] text-mainBlack font-semibold font-montserrat">
          ...
          {/* 4 */}
          <div className="hidden polo:flex flex-col gap-[20px] min-w-[400px]">
            {/* search */}
            <div className="hidden polo:block w-full polo:w-[310px] h-[46px] relative">
              <input
                type="text"
            ...
            <div className="hidden polo:flex w-auto items-start gap-[60px]">
              <div className="flex flex-col gap-[20px]">
                <p className="text-[16px] leading-[20px] text-mainBlack font-semibold font-montserrat">
                  {t("footer.p13")}
                </p>
        ...
        <div className="flex minitablet:hidden flex-col gap-[30px] bg-[#F5E7E7]">
          <div className="h-[46px] w-full relative flex items-center justify-center">
            <Link
              href="/"
              className={`w-[207px] h-[40px] ${styles.active} relative`}
            >
          ...
          <div className="w-full flex flex-col gap-[15px]">
            <button className="light-button w-full">Регистрация</button>
            <button className="button w-full">Войти в кабинет партнера</button>
          </div>

          <div className="h-[46px] bg-[#F9EFF0]  w-full px-[20px] justify-between flex items-center md:rounded-[20px] rounded-[10px] gap-[30px]">
            <p className="font-montserrat text-[15px] font-normal text-[#453C3C80]/40">
              {t("header.top.t1")}
            </p>
          ...
          <div className="bg-[#F5E7E7] flex justify-between w-full">
            <div>
              <p className="mb-[20px] text-[16px] leading-[20px] text-mainBlack font-semibold font-montserrat">
                {t("footer.p3")}
              </p>
          ...
          <div className="bg-[#F5E7E7] flex justify-between items-center">
            <div>
              <p className="bold-description">8(904) 999 99 99</p>
              <div className="flex items-center gap-[15px]">
                <Link
                  href="https://t.me/+88009999999"
                  target="_blank"
            ...
            <div>
              <p className="bold-description">8(800) 999 99 99</p>

              <div className="flex justify-end items-center gap-2 h-[46px]">
                <p className="text-[16px] leading-[24px] font-semibold font-montserrat text-mainBlack">
                  RU
                </p>
                <Popover>
          ...
          <div>
            <p className="font-montserrat text-[16px] text-[#453C3C33]">
              FLOWERS&OPT © 2024. Все права защищены.
            </p>
          </div>
        </div>
      </div>
